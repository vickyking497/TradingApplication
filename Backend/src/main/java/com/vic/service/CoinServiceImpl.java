...
import com.vic.config.AppConfig;
import com.vic.model.Coin;
import com.vic.repositry.CoinRepositry;
...
public class CoinServiceImpl implements CoinService{
	...
	@Autowired
	private CoinRepositry coinRepositry;
	
	@Autowired
	private ObjectMapper objectMapper;

    CoinServiceImpl(AppConfig appConfig) {
	...
	@Override
	public Coin findById(String coindId) throws Exception {
		Optional<Coin> optionalCoin = coinRepositry.findById(coindId);
