...
public class CoinController {
	...
	ResponseEntity<JsonNode> getMarketChart(@PathVariable String coinId,@RequestParam int days) throws Exception{
	...
	@GetMapping("/search")
	ResponseEntity<JsonNode> searchCoin(@RequestParam String keyword) throws Exception{
